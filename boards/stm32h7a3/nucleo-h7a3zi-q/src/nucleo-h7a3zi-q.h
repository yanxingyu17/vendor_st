/****************************************************************************
 * boards/arm/stm32h7/nucleo-h7a3zi-q/src/nucleo-h7a3zi-q.h
 *
...
#ifndef __BOARDS_ARM_STM32H7_NUCLEO_H7A3ZI_Q_SRC_NUCLEO_H7A3ZI_Q_H
#define __BOARDS_ARM_STM32H7_NUCLEO_H7A3ZI_Q_SRC_NUCLEO_H7A3ZI_Q_H
...
/* LED
 *
 * NUCLEO-H7A3ZI-Q has three software-controllable LEDs:
 *   LD1 - GREEN  - PB0
 *   LD2 - YELLOW - PE1   (NOT PB7 like H743ZI! Verified from ST official BSP
 *                        stm32h7xx-nucleo-bsp/stm32h7xx_nucleo.h)
 *   LD3 - RED    - PB14
 *
 * Note: NUCLEO-H743ZI uses PB7 for LD2 (BLUE). NUCLEO-H7A3ZI-Q is a
 * different PCB (MB1363) and physically wires LD2 to PE1 (YELLOW). This is
 * the single biggest pinmap difference between the two boards.
 */
...
/* Backward-compat alias: H7 stm32_autoleds.c references GPIO_LED_BLUE.
 * On NUCLEO-H7A3ZI-Q LD2 is YELLOW physically, but the autoled state machine
 * is color-agnostic; map BLUE to LD2 so existing autoleds.c logic works.
 */
...
#define NUCLEOH7A3ZI_PWMTIMER 1
 ...
 *   USB-related GPIO pins for the NUCLEO-H7A3ZI-Q board.
 *
 ****************************************************************************/
...
#endif /* __BOARDS_ARM_STM32H7_NUCLEO_H7A3ZI_Q_SRC_NUCLEO_H7A3ZI_Q_H */
